...
import static hundirlaflota.HundirLaFlota.clrscr;
import static hundirlaflota.HundirLaFlota.promptEnterKey;
...
public class JugadorHumano {
    ...
    public JugadorHumano(String nombre, Tablero tablero, Tablero tablero_ataque, ArrayList<Barco> Barcos) {
        this.nombre = nombre;
    ...
    public void jugarFlota(JugadorHumano defensor) {
        Scanner leer = new Scanner(System.in);
        boolean salir = false;
        while (!salir) {
            clrscr();
    ...
    private void atacarFlota(JugadorHumano defensor) {
        Scanner leer = new Scanner(System.in);
        System.out.println();
        this.getTablero_ataque().dibujarTablero();
